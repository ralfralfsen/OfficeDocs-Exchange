...
After successful execution of all five steps, MCDB acceleration will begin for every database instance with a corresponding MCDB instance.

### Step 1: Configure the proper values for your DAG
These DAG parameters are used to calculate the right MCDB size on your SSD drives:
