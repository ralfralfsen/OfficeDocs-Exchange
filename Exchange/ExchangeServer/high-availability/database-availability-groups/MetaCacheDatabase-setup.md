...
2. RAW SSD drives are installed, and SSD count and size is equal for each server in the DAG. Make sure that all SSDs are completely empty, unformatted and not write-protected. You can use either use:
